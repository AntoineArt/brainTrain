...
interface LevelConfig {
  ...
  maxMultA: number;   // cap for first operand in ×
  maxMultB: number;   // cap for second operand in ×
  maxDivB: number;    // cap for divisor in ÷
  maxDivAnswer: number; // cap for quotient in ÷
}
